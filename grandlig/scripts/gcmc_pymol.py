...
parser.add_argument(
    "-top", "--topology", default="system.pdb", help="System topology file."
)
parser.add_argument(
    "-trj", "--trajectory", default=None, help="Simulation trajectory file."
)
parser.add_argument(
    "-l", "--ligands", default=None, nargs="+", help="Ligand residue names"
)
parser.add_argument(
    "-s", "--sphere", default=None, help="GCMC sphere PDB file."
)
parser.add_argument(
    "-r",
    "--residues",
