...
This is a simple example showing how grand can be used to simulate GCMD for a protein solvated in water.
...
- The ``grand.samplers.StandardGCMCSphereSampler`` object contains all of the necessary GCMD variables for carrying out GCMC moves, and the arguments given should be self-explanatory.
